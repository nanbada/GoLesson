...
2. GoAlimi(`/Users/nanbada/projects/GoAlimi/`) 변경은 필요 시 가능하나, 기존 기능을 제한/제약하지 않는 범위여야 한다(2026-07-04 완화 — 현재 1개 학원 사용, 상용 단계 아님). 단, 이 저장소에서 직접 수정하지 않고 GoAlimi 프로젝트에서 별도 작업한다. Codex-Setup은 읽기 전용 참고다.
